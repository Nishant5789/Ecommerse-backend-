...
// const array = new Set(object.products.map((product) => product.category));

// const newArray = Array.from(array).map((val) => {
//   return { label: val, value: val, checked: false };
// });

const newArray = object.products.forEach((object) => {
  delete object["id"];
});
